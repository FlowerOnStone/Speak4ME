...
const FeaturedTile = (_a) => {
    ...
    return (React.createElement(Pressable, Object.assign({}, attributes, {
        style: StyleSheet.flatten([
            { width, height },
            containerStyle && containerStyle,
        ])
    }),
        React.createElement(ImageComponent, Object.assign({ resizeMode: "cover" }, imageProps, {
            source: imageSrc, style: StyleSheet.flatten([
                { width, height },
