...
export const SCREEN = {
    ...
    START: 'Start',
    LOGIN: 'Login',
    LOGIN_NAVIGATOR: 'Login Navigator',
    SET_NEW_PASSWORD: 'Set new password screen',
    VERIFY_FORGOT_PASSWORD: 'Verify forgot password screen',
    REGISTER: 'Register',
    HOME: 'Home',
    ...
    FORGOT_PASSWORD: 'ForgotPasswordNavigator',
    FORGOT_PASSWORD_NAVIGATOR: 'ForgotPasswordNavigator',
    INFO_NAVIGATOR: 'InfoNavigator',
    INFO: 'InfoScreen',
    CHANGE_INFO: 'ChangeInfoScreen',
